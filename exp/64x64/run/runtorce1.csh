...
#set loadedmodules=`module list`
echo Working directory is $cwd
set sst = 300
set run_name = rceprofile1		# label for the run
set exp_home = $cwd:h
...
# define variables
 set data_dir    = $SCRATCH/sam3d/${exp_name}    # temporary directory for model workdir, output, etc
...
nstop    = 864000,! (259200  30 days, 86400 = 10 days 432000 = 50 days,1296000=150) dt=10
nprint   = 360,
nstat    = 360,
nstatfrq = 360,
...
# mpirun ./ADV_MPDATA_SGS_TKE_RAD_CAM_MICRO_SAM1MOM > log.txt
srun  -n 64 -c 4 --cpu_bind=cores  ./ADV_MPDATA_SGS_TKE_RAD_CAM_MICRO_SAM1MOM > log.txt

...
! ----------Added by Da Yang on Oct 2015 to examine the virtual effect
real:: water_loading_coeff = 1.  
integer:: cold_pool_level = 0 ! added by Da Yang
integer:: homo_Tq_z1 = 0 ! added by Da Yang
integer:: homo_Tq_z2 = 0 ! added by Da Yang
real:: rad_factor = 1. ! added by Da Yang

!----------Argel Ramirez Reyes 2018: Homogeneize radiation in different portions of atomsphere
integer:: homo_rad_z1 = -1.0 ! ARR
integer:: homo_rad_z2 = 1000000.0 ! ARR
!----------Argel Ramirez Reyes 2018: To nudge clear sky specific humidity to its mean value
logical:: donudging_q_clearsky = .false.
real   :: tauq_clearsky = 10800.0
...
logical:: do_q_homo = .false. ! added by Da Yang
logical:: do_T_homo = .false. ! added by Da Yang
